...
import { Metric, MetricAlert, MetricState, SubscriptionState } from '../misc/types';
...
function SearchMetrics(props: {
  ...
  return (
    <>
      ...
      <MetricTable titleMode="search" onSelectMetric={(metric: Metric) => props.onSelectMetric(metric, null)} metricWithThresholds={metricWithThresholds} isLoading={props.metricState.isLoading || props.subscriptionState.isLoading} onClickUpdateSubscriptions={props.onClickUpdateSubscriptions} />
    </>
  );
}
